...
class BloodList
{
    ...
    // Correspond to BloodList::addBlood()
    ...
    // Correspond to BloodList::getBlood()
    method getBlood(id: int) returns (blood: Blood)
    requires Valid(); ensures Valid();
    requires UniqueId(); ensures UniqueId();
    ...
    // Correspond to BloodList::removeBlood()
    ...
    // Correspond to BloodList::extractBlood()
    method extractBlood(id: int) returns (blood: Blood)
    requires Valid(); ensures Valid();
    requires UniqueId(); ensures UniqueId();
